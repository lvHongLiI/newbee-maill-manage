 ...
 * @Description: TODO(编号生成工具类，使用snowflake算法) 
 * @author 江伟  
 * @date 2019年7月10日 上午9:55:22 
...
public class IDGeneratorUtil {
	...
	private long datacenterId; // 应用服务编号
	private long machineId; // 服务序列值
	private long sequence = 0L; // 序列号
	private long lastStmp = -1L;// 上一次时间戳

	/**
	 * 初始化 
	 * 设置应用服务编号（默认值为1，根据应用服务顺序依次加1） ，服务序列值（默认值为10，根据服务数量依次加1）
	 */
